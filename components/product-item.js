...
class ProductItem extends HTMLElement {
  ...
  constructor(index, id, title, price, description, category, image, start_in_cart) {
    ...
    if (in_cart === true) {
      add_button.innerHTML = "Remove from cart";
    }
    ...
    function add_item() {
      ...
      localStorage.setItem('existance', ProductItem.cart_table.toString());
      console.log(localStorage.getItem('existance'));
      localStorage.setItem('cart_count', ProductItem.item_count.toString());
    }
